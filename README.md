...
- THE QUESTION (AKA `BASE CARD`)
  ...
  - GIVEN A CERTAIN CATEGORY WAS PREVIOUSLY DECIDED ON, AN ENTRY IS RANDOMLY SELECTED FROM THE DATABASE.
    - this entry is called `CHOSEN CARD` **✅**
...
- THE ANSWERS (AKA `RELATED CARDS`)
  ...
  > 🎃THE **X** CARDS PRESENTED HERE MUST INCLUDED THE `CHOSEN CARD` AND 🎃 **X-1** `ALTERNATE CARDS`

  - CARD 🥇 <-- THE CONTENT HERE COMES FROM THE ENTRY LOADED IN THE `CHOSEN CARD` **✅**
  - CARD 🥈 <-- THE CONTENT HERE COMES FROM THE ENTRY LOADED IN `ALTERNATE CARD`
    - IMAGE
    - NAME
  - CARD 🥉 <-- THE CONTENT HERE COMES FROM THE ENTRY LOADED IN `ALTERNATE CARD`
    - IMAGE
...
- FOOTER
  - OVERALL SITE INFO AND LINKS NOT PLACED ELSEWHERE

# ✨WHAT IS PENDING?✨

- [ ] 🏅ADD ACTION HANDLER WHEN A PLAYER CLICKS A CARD (**SAVING THE VALUE IN THE API**)
- [ ] 🏅ADD ACTION HANDLER WHEN A PLAYER CLICKS A CARD (**DISPLAYING THE CORRECT SUCCESS ANIMATION EFFECT**)
- [ ] 🏅ADD ACTION HANDLER WHEN A PLAYER CLICKS A CARD (**DISABLING THE INCORRECT ANSWER**)
- [ ] 🏅ADD ACTION HANDLER WHEN A PLAYER CLICKS A CARD (**CLEARING THE SCREEN AND RESTARTING THE PROCESS WITHOUT HAVING TO LOG IN AGAIN**)
